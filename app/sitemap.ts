...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: {
    ...
    { path: '/fr/services/lead-generation', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/es/services/lead-generation', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/services/call-center', priority: 0.9, changeFrequency: 'monthly' },
    { path: '/fr/services/call-center', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/es/services/call-center', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/services/email-automation', priority: 0.9, changeFrequency: 'monthly' },
    { path: '/fr/services/email-automation', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/es/services/email-automation', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/services/ai-search-visibility', priority: 0.9, changeFrequency: 'monthly' },
    { path: '/fr/services/ai-search-visibility', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/es/services/ai-search-visibility', priority: 0.8, changeFrequency: 'monthly' },
